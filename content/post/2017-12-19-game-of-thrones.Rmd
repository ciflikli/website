...
intheway <- c("Sarsfield", "Hornvale", "Cider Hall",
              "Hayford Castle", "Griffin's Roost")

#Subsetting
locations <- locations[locations@data$type == "Castle" |
                       locations@data$name %in% interesting, ]
locations <- locations[locations@data$name %nin% intheway, ]
...
tm_shape(holds) +
  tm_dots("name", size = .05, alpha = .5, shape = castle, border.lwd = NA, ymod = .2) + 
#Fluff
...
Download the map in [PDF.](/img/westeros.pdf)

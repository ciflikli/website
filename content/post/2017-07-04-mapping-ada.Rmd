...
Edit to Disclaimer: I decided to replace the hack with static pictures instead. Keeping the code just in case, but they are now commented out in invisible code chunks in RMarkdown---go to my website repo on GitHub for the underlying code.

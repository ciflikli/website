...
My empirical strategy is as follows. First, using the Cunningham and Lemke [(2013)](https://www.researchgate.net/publication/259435120_Combining_Civil_and_Interstate_Wars) data, which contains features on both interstate and civil wars, I explore the determinants of conflict duration. Second, I replicate 25 studies on conflict duration published since 1996. I train various machine learning algorithms on the duration studies to identify and compare variable importance measures across studies. Finally, I train deep learning models using Keras on the Cunningham and Lemke dataset to capture the complex underlying interactions and make temporal predictions.
